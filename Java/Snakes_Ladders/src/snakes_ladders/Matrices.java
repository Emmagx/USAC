...
//Declare all the arrays to use
    static double [][] matriz1Div(){ double [][] matriz1Div = {{10, 10, 1, 3},
                                                            {9, 14, 22, 6},
                                                            {7, 8, 29, 3},
                                                            {6, 8, 9, 2},};
        return  matriz1Div;
    ...
    static double [][] matriz3Div(){double [][] matriz3Div = {{1, 12, 9, 12},
                                                            {7, 6, 3, 2},
                                                            {0, 5, 6, 18},
                                                            {6, 51, 6, 10},};
        return matriz3Div;}
    
    static double [][] matriz4Div(){ double [][] matriz4Div = {{8, 19, 96, 4},
                                                            {27, 33, 6, 8},
                                                            {4, 71, 9, 7},
                                                            {8, 22, 14, 6},};
        return matriz4Div;}
    ...
    static int [][] matriz4Suma(){ int [][] matriz4Suma = { {0, 2, 15, 1, 72},
                                                            {21, 48, 62, 7, 33},
                                                            {4, 88, 0, 68, 4},
                                                            {25, 18, 24, 7, 55},
                                                            {24, 15, 36, 5, 98}};
    ...
    static int [][] matriz5Suma(){ int [][] matriz5Suma = { {0, 1, 15, 44, 36},
                                                            {1, 78, 65, 32, 4},
                                                            {48, 33, 39, 0, 55},
                                                            {14, 98, 63, 20, 15},
                                                            {11, 39, 84, 7, 1}};
    ...
    static int [][] matriz6Suma(){ int [][] matriz6Suma = { {55, 25, 66, 48, 98},
                                                            {0, 45, 2, 3, 77},
                                                            {2, 9, 14, 10, 20},
                                                            {35, 87, 66, 2, 32},
                                                            {25, 8, 4, 9, 39}};
